...
<div id="box_menu">
        ...
        <a href='pagina_inicial_adm.php'><button class='btn btn-outline-light' id='login_1'>VOLTAR</button></a>    
        </div>

       
        <h1 id='txt'><b>SEUS ALUNOS</b></h1>"
</body>
</html>
<?php
session_start();
...
$sql = "SELECT c.nome_curso, al.nome_aluno, c.tipos_curso, a.nome_adm, al.email_aluno from curso as c, adm as a, aluno as al, matricula as m
where c.id_adm = a.id_adm and m.id_aluno = al.id_aluno and c.id_curso = m.id_curso and a.email_adm = '$email'";
...
if($result->num_rows > 0){
    ...
    while($row = $result -> fetch_assoc()){
        ...
        echo "<tbody>
                     ...
                     <tr><td><center><b>nome do aluno</b></center></td></tr>
                     <tr><td><center>".$row["nome_aluno"]."</center></td></tr>
              </tbody>";

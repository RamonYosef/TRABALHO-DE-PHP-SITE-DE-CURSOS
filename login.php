...
<body>
    ...
    <img src="img/Captura de tela 2023-02-16 205922.png" alt="" id="img">
        ...
        <a href="login_adm.php"><button  class="btn btn-outline-light" id="login_1">ENTRAR_ADM</button></li></a>
            <a href="formularios_adm.php"><button class="btn btn-outline-light"id="login_3">REGISTRA-SE_ADM</button></li></a>
            <a href="formularios.php"><button class="btn btn-outline-light"id="login_2">REGISTRA-SE_ALUNO</button></li></a>
           
        </div>

    <div id="box">
       <center><h1 id="titulo">LOGIN ALUNO</h1></center> 
       <br>
        <form action="back_and/open.php" method="post">
